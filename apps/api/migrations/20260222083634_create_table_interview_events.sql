...
CREATE INDEX idx_interview_events_metadata     ON interview_events USING GIN (metadata);

-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP INDEX IF EXISTS idx_interview_events_metadata;
DROP INDEX IF EXISTS idx_interview_events_created_at;
DROP INDEX IF EXISTS idx_interview_events_event_type;
